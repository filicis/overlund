 ...
 */
final class Version20221124081256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_detail (id INT AUTO_INCREMENT NOT NULL, tag VARCHAR(32) NOT NULL, addr LONGTEXT DEFAULT NULL, adr1 VARCHAR(60) DEFAULT NULL, adr2 VARCHAR(60) DEFAULT NULL, adr3 VARCHAR(60) DEFAULT NULL, city VARCHAR(60) DEFAULT NULL, stae VARCHAR(60) DEFAULT NULL, post VARCHAR(20) DEFAULT NULL, ctry VARCHAR(60) DEFAULT NULL, phon LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', email LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', fax LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', www LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locked TINYINT(1) DEFAULT NULL, confidential TINYINT(1) DEFAULT NULL, privacy TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE family (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', project_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', husband_relation_id INT DEFAULT NULL, wife_relation_id INT DEFAULT NULL, media_id INT NOT NULL, last_change DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', crea VARCHAR(20) DEFAULT NULL, xref VARCHAR(20) DEFAULT NULL, locked TINYINT(1) DEFAULT NULL, confidential TINYINT(1) DEFAULT NULL, privacy TINYINT(1) DEFAULT NULL, INDEX IDX_A5E6215B166D1F9C (project_id), UNIQUE INDEX UNIQ_A5E6215B798F97CA (husband_relation_id), UNIQUE INDEX UNIQ_A5E6215B8A951AAD (wife_relation_id), UNIQUE INDEX UNIQ_A5E6215BEA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE individual (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', project_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', media_id INT NOT NULL, last_change DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', crea VARCHAR(20) DEFAULT NULL, xref VARCHAR(20) DEFAULT NULL, sex VARCHAR(1) DEFAULT NULL, locked TINYINT(1) DEFAULT NULL, confidential TINYINT(1) DEFAULT NULL, privacy TINYINT(1) DEFAULT NULL, INDEX IDX_8793FC17166D1F9C (project_id), UNIQUE INDEX UNIQ_8793FC17EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
