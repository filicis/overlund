 ...
 */
final class Version20221127183011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repository_record ADD identifier_link_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A899E030576DF789 ON repository_record (identifier_link_id)');
        $this->addSql('ALTER TABLE source_record ADD identifier_link_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2DCBBA77576DF789 ON source_record (identifier_link_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A899E030576DF789 ON repository_record');
        $this->addSql('ALTER TABLE repository_record DROP identifier_link_id');
        $this->addSql('ALTER TABLE source_record DROP FOREIGN KEY FK_2DCBBA77576DF789');
        $this->addSql('DROP INDEX UNIQ_2DCBBA77576DF789 ON source_record');
        $this->addSql('ALTER TABLE source_record DROP identifier_link_id');
