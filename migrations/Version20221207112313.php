 ...
 */
final class Version20221207112313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_detail (id INT AUTO_INCREMENT NOT NULL, tag VARCHAR(32) NOT NULL, agency VARCHAR(255) DEFAULT NULL, religion VARCHAR(255) DEFAULT NULL, cause VARCHAR(255) DEFAULT NULL, date VARCHAR(255) DEFAULT NULL, addr LONGTEXT DEFAULT NULL, adr1 VARCHAR(60) DEFAULT NULL, adr2 VARCHAR(60) DEFAULT NULL, adr3 VARCHAR(60) DEFAULT NULL, city VARCHAR(60) DEFAULT NULL, stae VARCHAR(60) DEFAULT NULL, post VARCHAR(20) DEFAULT NULL, ctry VARCHAR(60) DEFAULT NULL, phon LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', email LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', fax LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', www LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locked TINYINT(1) DEFAULT NULL, confidential TINYINT(1) DEFAULT NULL, privacy TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE family (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', project_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', husband_relation_id INT DEFAULT NULL, wife_relation_id INT DEFAULT NULL, identifier_link_id INT DEFAULT NULL, media_id INT DEFAULT NULL, last_change DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', crea VARCHAR(20) DEFAULT NULL, xref VARCHAR(20) DEFAULT NULL, locked TINYINT(1) DEFAULT NULL, confidential TINYINT(1) DEFAULT NULL, privacy TINYINT(1) DEFAULT NULL, INDEX IDX_A5E6215B166D1F9C (project_id), UNIQUE INDEX UNIQ_A5E6215B798F97CA (husband_relation_id), UNIQUE INDEX UNIQ_A5E6215B8A951AAD (wife_relation_id), UNIQUE INDEX UNIQ_A5E6215B576DF789 (identifier_link_id), UNIQUE INDEX UNIQ_A5E6215BEA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media_record (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', project_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', identifier_link_id INT DEFAULT NULL, last_change DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', crea VARCHAR(20) DEFAULT NULL, xref VARCHAR(20) DEFAULT NULL, locked TINYINT(1) DEFAULT NULL, confidential TINYINT(1) DEFAULT NULL, privacy TINYINT(1) DEFAULT NULL, INDEX IDX_274D054F166D1F9C (project_id), UNIQUE INDEX UNIQ_274D054F576DF789 (identifier_link_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE repository_record (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', project_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', identifier_link_id INT DEFAULT NULL, last_change DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', crea VARCHAR(20) DEFAULT NULL, xref VARCHAR(20) DEFAULT NULL, name VARCHAR(255) NOT NULL, addr LONGTEXT DEFAULT NULL, adr1 VARCHAR(60) DEFAULT NULL, adr2 VARCHAR(60) DEFAULT NULL, adr3 VARCHAR(60) DEFAULT NULL, city VARCHAR(60) DEFAULT NULL, stae VARCHAR(60) DEFAULT NULL, post VARCHAR(20) DEFAULT NULL, ctry VARCHAR(60) DEFAULT NULL, phon LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', email LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', fax LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', www LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_A899E030166D1F9C (project_id), UNIQUE INDEX UNIQ_A899E030576DF789 (identifier_link_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE restrictions (id INT AUTO_INCREMENT NOT NULL, locked TINYINT(1) NOT NULL, confidential TINYINT(1) NOT NULL, privacy TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE source_record (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', project_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', identifier_link_id INT DEFAULT NULL, last_change DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', crea VARCHAR(20) DEFAULT NULL, xref VARCHAR(20) DEFAULT NULL, author VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, abbreviation VARCHAR(255) DEFAULT NULL, publication VARCHAR(255) DEFAULT NULL, INDEX IDX_2DCBBA77166D1F9C (project_id), UNIQUE INDEX UNIQ_2DCBBA77576DF789 (identifier_link_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE submitter_record (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', project_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', identifier_link_id INT DEFAULT NULL, last_change DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', crea VARCHAR(20) DEFAULT NULL, xref VARCHAR(20) DEFAULT NULL, addr LONGTEXT DEFAULT NULL, adr1 VARCHAR(60) DEFAULT NULL, adr2 VARCHAR(60) DEFAULT NULL, adr3 VARCHAR(60) DEFAULT NULL, city VARCHAR(60) DEFAULT NULL, stae VARCHAR(60) DEFAULT NULL, post VARCHAR(20) DEFAULT NULL, ctry VARCHAR(60) DEFAULT NULL, phon LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', email LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', fax LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', www LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_8EA7E5D166D1F9C (project_id), UNIQUE INDEX UNIQ_8EA7E5D576DF789 (identifier_link_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE anci_structure ADD CONSTRAINT FK_813E29B2F34627C5 FOREIGN KEY (submitter_record_id) REFERENCES submitter_record (id)');
        ...
        $this->addSql('ALTER TABLE citation_structure ADD CONSTRAINT FK_6B4134172563E6C2 FOREIGN KEY (source_record_id) REFERENCES source_record (id)');
        ...
        $this->addSql('ALTER TABLE media_record ADD CONSTRAINT FK_274D054F576DF789 FOREIGN KEY (identifier_link_id) REFERENCES identifier_link (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE repository_record ADD CONSTRAINT FK_A899E030576DF789 FOREIGN KEY (identifier_link_id) REFERENCES identifier_link (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE source_record ADD CONSTRAINT FK_2DCBBA77166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
        $this->addSql('ALTER TABLE source_record ADD CONSTRAINT FK_2DCBBA77576DF789 FOREIGN KEY (identifier_link_id) REFERENCES identifier_link (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE source_repository_citation ADD CONSTRAINT FK_9A26AA7E9587F804 FOREIGN KEY (repository_record_id) REFERENCES repository_record (id)');
        $this->addSql('ALTER TABLE source_repository_citation ADD CONSTRAINT FK_9A26AA7E2563E6C2 FOREIGN KEY (source_record_id) REFERENCES source_record (id)');
        $this->addSql('ALTER TABLE submitter_record ADD CONSTRAINT FK_8EA7E5D166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
        $this->addSql('ALTER TABLE submitter_record ADD CONSTRAINT FK_8EA7E5D576DF789 FOREIGN KEY (identifier_link_id) REFERENCES identifier_link (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE submitter_structure ADD CONSTRAINT FK_D1BA6523F34627C5 FOREIGN KEY (submitter_record_id) REFERENCES submitter_record (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repository_record DROP FOREIGN KEY FK_A899E030576DF789');
        $this->addSql('ALTER TABLE source_record DROP FOREIGN KEY FK_2DCBBA77166D1F9C');
        $this->addSql('ALTER TABLE source_record DROP FOREIGN KEY FK_2DCBBA77576DF789');
