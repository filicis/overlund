...
use       App\Gedinterface\Structure\GedMediaStructure;
	 ...
	 *	class GedVParser
	 *
	 *	- Understøtter Gedcom version 5.5 som beskrevet i
	 *
	 **/


class GedVparser extends AbstractGedParser
{
...
//*************************************************************************************************
  ...
  /**
   *  function individualRecord(GedIndividualRecord $record)
   *
   **/
